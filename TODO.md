...
- [ ] **Kvar att verifiera mot staging:** hårda MCP-gränsen (`supabase/tests/context_mcp_scope.sql` query 4 → 0 rader). Ej heller exercerat av seed: negativa fallen (Free-medlem nekas, 6:e medlem nekas) — testa manuellt via UI.
